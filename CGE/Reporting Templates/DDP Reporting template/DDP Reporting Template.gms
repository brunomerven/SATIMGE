...
DDP_report1('EngInvestment',EngSector,EngSubSector,Years,RUN)   =(SUM(PRC$(ENGSECT(PRC,EngSector,EngSubSector)),TCST_INVC('REGION1',Years,PRC)))/1000/EXR ;
DDP_report1('Investment','NA','NA',years,RUN)   =sum((C,IT),QINVX(C,IT,'base',years,'2055')*PQ0(C))/EXR ;
DDP_report1('TotalWage',H,'NA',years,RUN)       =YIX(H,'base',years,'2055')              ;
